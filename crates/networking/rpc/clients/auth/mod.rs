...
impl EngineClient {
    ...
    /// Like [`EngineClient::engine_forkchoice_updated_v3`] but for Amsterdam
    /// payloads: V4 attributes carry the EIP-7843 slot number and the
    /// execution-apis#796 target gas limit, both mandatory on FCUv4.
    ...
    /// Like [`EngineClient::engine_get_payload_v5`] but for Amsterdam
    /// payloads (getPayloadV5 rejects Amsterdam timestamps; V6 is the
    /// BAL-carrying Amsterdam variant).
    ...
    fn capabilities() -> Vec<String> {
        vec![
            ...
            "engine_forkchoiceUpdatedV4".to_owned(),
            "engine_getPayloadV4".to_owned(),
            "engine_getPayloadV5".to_owned(),
            "engine_getPayloadV6".to_owned(),
