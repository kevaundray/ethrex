...
mod no_std_tracing {
    ...
    /// No-op tracer stub for no_std environments.
    ...
    impl LevmCallTracer {
        ...
        pub fn exit_early(
            &mut self,
            _gas_used: u64,
            _error: Option<alloc::string::String>,
        ) -> Result<(), InternalError> {
            Ok(())
        }
...
mod std_tracing {
    ...
    use bytes::Bytes;
    pub use ethrex_common::tracing::CallType;
    use ethrex_common::{
        Address, U256,
        tracing::{CallLog, CallTraceFrame},
        types::Log,
    };
